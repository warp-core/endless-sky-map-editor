    ...
    QWidget(parent), mapData(mapData), galaxyView(galaxyView)
{
    ...
    QGridLayout *interstellarLayout = new QGridLayout(this);
    hidden = new QCheckBox("Hidden", this);
    connect(hidden, SIGNAL(clicked()), this, SLOT(HiddenClicked()));
    interstellarLayout->addWidget(hidden, 0, 3, 1, 1);
    shrouded = new QCheckBox("Shrouded", this);
    connect(shrouded, SIGNAL(clicked()), this, SLOT(ShroudedClicked()));
    interstellarLayout->addWidget(shrouded, 1, 3, 1, 1);
    inaccessible = new QCheckBox("Inaccessible", this);
    connect(inaccessible, SIGNAL(clicked()), this, SLOT(InaccessibleClicked()));
    interstellarLayout->addWidget(inaccessible, 2, 3, 1, 1);

    interstellarLayout->addWidget(new QLabel("Arrival:", this), 0, 1, 1, 1);
    interstellarLayout->addWidget(new QLabel("Departure:", this), 0, 2, 1, 1);
    interstellarLayout->addWidget(new QLabel("Hyperspace:", this), 1, 0, 1, 1);
    ...
    interstellarLayout->addWidget(arrivalFromHabitable, 3, 0, 1, 2);
    layout->addLayout(interstellarLayout);
